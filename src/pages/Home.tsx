      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
          ...
          >
            ...
            <h2 className="text-2xl font-semibold text-teal-900 mb-2">Therapeutin / Therapeut</h2>
            <p className="text-slate-500 leading-relaxed">
              Übungen verwalten, Programme zusammenstellen und Zugangscodes generieren.
            </p>
          ...
          >
            ...
            <h2 className="text-2xl font-semibold text-white mb-2">Patientin / Patient</h2>
